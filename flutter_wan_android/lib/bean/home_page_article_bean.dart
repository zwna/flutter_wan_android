...
class HomePageArticleBean {

  int errorCode;
  String errorMsg;
  HomePageArticleDataBean data;

  HomePageArticleBean.fromParams({this.errorCode, this.errorMsg, this.data});

  factory HomePageArticleBean(jsonStr) => jsonStr == null ? null : jsonStr is String ? new HomePageArticleBean.fromJson(json.decode(jsonStr)) : new HomePageArticleBean.fromJson(jsonStr);

  HomePageArticleBean.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new HomePageArticleDataBean.fromJson(jsonRes['data']);
  }
...
class HomePageArticleDataBean {
  ...
  int total;
  bool over;
  List<HomePageArticleDetailBean> datas;

  HomePageArticleDataBean.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});

  HomePageArticleDataBean.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']){
      datas.add(datasItem == null ? null : new HomePageArticleDetailBean.fromJson(datasItem));
    }
  }
...
class HomePageArticleDetailBean {
  ...
  HomePageArticleDetailBean.fromParams({this.chapterId, this.courseId, this.id, this.publishTime, this.superChapterId, this.type, this.userId, this.visible, this.zan, this.collect, this.fresh, this.apkLink, this.author, this.chapterName, this.desc, this.envelopePic, this.link, this.niceDate, this.origin, this.projectLink, this.superChapterName, this.title, this.tags});

  HomePageArticleDetailBean.fromJson(jsonRes) {
