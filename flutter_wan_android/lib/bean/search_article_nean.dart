...
class SearchArticleBean {
  ...
  int errorCode;
  String errorMsg;
  SearchArticleAuthorBean data;

  SearchArticleBean.fromParams({this.errorCode, this.errorMsg, this.data});

  factory SearchArticleBean(jsonStr) => jsonStr == null ? null : jsonStr is String ? new SearchArticleBean.fromJson(json.decode(jsonStr)) : new SearchArticleBean.fromJson(jsonStr);

  SearchArticleBean.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new SearchArticleAuthorBean.fromJson(jsonRes['data']);
  }
...
class SearchArticleAuthorBean {
  ...
  int total;
  bool over;
  List<SearchArticleDetailBean> datas;

  SearchArticleAuthorBean.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});

  SearchArticleAuthorBean.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']){
      datas.add(datasItem == null ? null : new SearchArticleDetailBean.fromJson(datasItem));
    }
  }
...
class SearchArticleDetailBean {
  ...
  String title;
  List<SearchArticleUrlBean> tags;

  SearchArticleDetailBean.fromParams({this.chapterId, this.courseId, this.id, this.publishTime, this.superChapterId, this.type, this.userId, this.visible, this.zan, this.collect, this.fresh, this.apkLink, this.author, this.chapterName, this.desc, this.envelopePic, this.link, this.niceDate, this.origin, this.projectLink, this.superChapterName, this.title, this.tags});

  SearchArticleDetailBean.fromJson(jsonRes) {
    ...
    for (var tagsItem in tags == null ? [] : jsonRes['tags']){
      tags.add(tagsItem == null ? null : new SearchArticleUrlBean.fromJson(tagsItem));
    }
  }
...
class SearchArticleUrlBean {

  String name;
  String url;

  SearchArticleUrlBean.fromParams({this.name, this.url});

  SearchArticleUrlBean.fromJson(jsonRes) {
    name = jsonRes['name'];
    url = jsonRes['url'];
  }
