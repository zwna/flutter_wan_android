...
class ProjectListBean {
  ...
  int errorCode;
  String errorMsg;
  ProjectListInfoBean data;

  ProjectListBean.fromParams({this.errorCode, this.errorMsg, this.data});

  factory ProjectListBean(jsonStr) => jsonStr == null ? null : jsonStr is String ? new ProjectListBean.fromJson(json.decode(jsonStr)) : new ProjectListBean.fromJson(jsonStr);

  ProjectListBean.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new ProjectListInfoBean.fromJson(jsonRes['data']);
  }
...
class ProjectListInfoBean {
  ...
  int total;
  bool over;
  List<ProjectListInfoDetailBean> datas;

  ProjectListInfoBean.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});

  ProjectListInfoBean.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']){
      datas.add(datasItem == null ? null : new ProjectListInfoDetailBean.fromJson(datasItem));
    }
  }
...
class ProjectListInfoDetailBean {
  ...
  String title;
  List<ProjectListNameBean> tags;

  ProjectListInfoDetailBean.fromParams({this.chapterId, this.courseId, this.id, this.publishTime, this.superChapterId, this.type, this.userId, this.visible, this.zan, this.collect, this.fresh, this.apkLink, this.author, this.chapterName, this.desc, this.envelopePic, this.link, this.niceDate, this.origin, this.projectLink, this.superChapterName, this.title, this.tags});

  ProjectListInfoDetailBean.fromJson(jsonRes) {
    ...
    for (var tagsItem in tags == null ? [] : jsonRes['tags']){
      tags.add(tagsItem == null ? null : new ProjectListNameBean.fromJson(tagsItem));
    }
  }
...
class ProjectListNameBean {

  String name;
  String url;

  ProjectListNameBean.fromParams({this.name, this.url});

  ProjectListNameBean.fromJson(jsonRes) {
    name = jsonRes['name'];
    url = jsonRes['url'];
  }
