...
class SpecificKnowledgeBean {

  int errorCode;
  String errorMsg;
  SpecificKnowledgeDataBean data;

  SpecificKnowledgeBean.fromParams({this.errorCode, this.errorMsg, this.data});

  factory SpecificKnowledgeBean(jsonStr) => jsonStr == null ? null : jsonStr is String ? new SpecificKnowledgeBean.fromJson(json.decode(jsonStr)) : new SpecificKnowledgeBean.fromJson(jsonStr);

  SpecificKnowledgeBean.fromJson(jsonRes) {
    errorCode = jsonRes['errorCode'];
    errorMsg = jsonRes['errorMsg'];
    data = jsonRes['data'] == null ? null : new SpecificKnowledgeDataBean.fromJson(jsonRes['data']);
  }
...
class SpecificKnowledgeDataBean {
  ...
  int total;
  bool over;
  List<SpecificKnowledgeDetailBean> datas;

  SpecificKnowledgeDataBean.fromParams({this.curPage, this.offset, this.pageCount, this.size, this.total, this.over, this.datas});

  SpecificKnowledgeDataBean.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']){
      datas.add(datasItem == null ? null : new SpecificKnowledgeDetailBean.fromJson(datasItem));
    }
  }
...
class SpecificKnowledgeDetailBean {
